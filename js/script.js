...
(function () {
    return __awaiter(this, void 0, void 0, function* () {
        var config = yield res_1.getConfig();
...
var MetroMap = (function (_super) {
    ...
    MetroMap.prototype.makeMap = function () {
        return __awaiter(this, void 0, void 0, function* () {
            var _this = this;
            ...
            ui.addLayerSwitcher(this.map, [tilelayers_1.mapbox, tilelayers_1.mapnik, tilelayers_1.osmFrance, tilelayers_1.openMapSurfer, tilelayers_1.cartoDBNoLabels, tilelayers_1.wikimapia]);
            ...
            this.addContextMenu();
            var json = yield networkPromise;
            this.network = new nw.Network(json);
            var center = geo.getCenter(this.network.platforms.map(function (p) { return p.location; }));
            this.config.center = [center.lat, center.lng];
            var bounds = new L.LatLngBounds(this.network.platforms.map(function (p) { return p.location; }));
            ...
            var lineRules = yield lineRulesPromise;
            this.lineRules = lineRules;
            // wait.textContent = 'adding content...';
            this.resetMapView();
            this.map.addLayer(tilelayers_1.mapbox);
            this.map.on('overlayupdate', function (overlay) {
                _this.redrawNetwork();
            ...
            yield faq.whenAvailable;
            faq.addTo(this.map);
            // wait.textContent = 'loading tiles...';
            var tileLoadEvent = yield tileLoadPromise;
            // wait.parentElement.removeChild(wait);
            util.fixFontRendering();
            this.map.on('layeradd layerremove', function (e) { return util.fixFontRendering(); });
...
exports.openMapSurfer = L.tileLayer('http://korona.geog.uni-heidelberg.de/tiles/roads/x={x}&y={y}&z={z}', {
