...
var mapbox = (function () {
    return new L.TileLayer('https://{s}.tiles.mapbox.com/v3/inker.km1inchd/{z}/{x}/{y}.png', {
        minZoom: 9,
        id: 'inker.km1inchd',
        //detectRetina: true,
        reuseTiles: true,
...
var MetroMap = (function () {
    ...
    MetroMap.prototype.addListeners = function () {
        ...
        this.map.on('moveend', function (e) {
            _this.exTranslate = util.parseTransform(_this.overlay.style.transform);
    ...
    MetroMap.prototype.showPlate = function (event) {
        ...
        var dataset = dummyCircle.dataset;
...
function makePlate(circle) {
    ...
    var ru = circle.dataset['ru'];
    var fi = circle.dataset['fi'];
...
function getUserLanguage() {
    var userLanguage = (navigator.userLanguage || navigator.language).substr(0, 2).toLowerCase();
...
function getCircumcenter(positions) {
    ...
    return new L.Point(c.y * bSq - b.y * cSq, b.x * cSq - c.x * bSq).divideBy(2.0 * (b.x * c.y - b.y * c.x)).add(positions[0]);
}
